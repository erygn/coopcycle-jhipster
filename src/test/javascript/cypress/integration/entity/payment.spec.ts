...
describe('Payment e2e test', () => {
  ...
  const paymentSample = { id: 'e7c863fc-bc91-4b4a-9ab5-6995844fcdf2', amount: 15223 };
  ...
  describe('new Payment page', () => {
    ...
    it('should create an instance of Payment', () => {
      cy.get(`[data-cy="id"]`).type('3e0a386a-9a84-4449-bd6c-5cd688aa60a3').should('have.value', '3e0a386a-9a84-4449-bd6c-5cd688aa60a3');

      cy.get(`[data-cy="amount"]`).type('9171').should('have.value', '9171');
