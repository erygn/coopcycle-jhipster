...
describe('Restaurant e2e test', () => {
  ...
  const restaurantSample = { name: 'a', location: 'digital b Soft' };
  ...
  describe('new Restaurant page', () => {
    ...
    it('should create an instance of Restaurant', () => {
      cy.get(`[data-cy="name"]`).type('o').should('have.value', 'o');

      cy.get(`[data-cy="location"]`).type('Refined XML').should('have.value', 'Refined XML');
