...
public class BasketResource {
     ...
     */
    @GetMapping("/baskets")
    public List<BasketDTO> getAllBaskets(@RequestParam(required = false) String filter) {
        if ("grocery-is-null".equals(filter)) {
            log.debug("REST request to get all Baskets where grocery is null");
            return basketService.findAllWhereGroceryIsNull();
        }
