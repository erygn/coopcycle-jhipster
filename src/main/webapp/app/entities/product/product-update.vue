  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="coopcycleApp.product.home.createOrEditLabel"
          data-cy="ProductCreateUpdateHeading"
          v-text="$t('coopcycleApp.product.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('coopcycleApp.product.name')" for="product-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
            ...
            <div v-if="$v.product.name.$anyDirty && $v.product.name.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.product.name.minLength" v-text="$t('entity.validation.minlength', { min: 4 })">
                This field is required to be at least 4 characters.
              </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('coopcycleApp.product.price')" for="product-price">Price</label>
            <input
              type="number"
              class="form-control"
              name="price"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('coopcycleApp.product.quantity')" for="product-quantity">Quantity</label>
            <input
              type="number"
              class="form-control"
              name="quantity"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('coopcycleApp.product.basket')" for="product-basket">Basket</label>
            <select class="form-control" id="product-basket" data-cy="basket" name="basket" v-model="product.basket">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="product.basket && basketOption.id === product.basket.id ? product.basket : basketOption"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('coopcycleApp.product.restaurant')" for="product-restaurant">Restaurant</label>
            <select class="form-control" id="product-restaurant" data-cy="restaurant" name="restaurant" v-model="product.restaurant">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="product.restaurant && restaurantOption.id === product.restaurant.id ? product.restaurant : restaurantOption"
